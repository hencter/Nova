...
This directory contains **tool-specific deep dives** — each file analyzes a single agent coding platform, its architecture, strengths, and unique design patterns.
